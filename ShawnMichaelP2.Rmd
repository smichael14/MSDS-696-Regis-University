...
```{r}
# train and validate  performance with the train data
...
Each train iteration was leveraged to build a model, and I held out the validate portion so I could validate my iterative model.
